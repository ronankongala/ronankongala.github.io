...
- **Interactive terminal** -- type real commands (`help`, `projects`, `open 1-21`, `whoami`, `contact`, `clear`) to navigate the site
- **Filterable project grid** -- 21 case studies, click any tag to filter, click a card for the full write-up in a modal
